...
type MWobj
    ...
    maxwindow::Int
    count::Array{Int, 1}
    iterator_windowcenter::Range{Int}
    mw_indat
    mw_outdat
    mw_idx::Array{Int, 1}
    xin
...
function init_MovingWindow{tp}(xin::AbstractArray{tp, 2}; ObsPerYear::Int = 46, windowsize::Int = 11, edgecut::Int = 0, startidx::Int = 1, numoutvars::Int = 0)
...
function mapMovingWindow(function2mw, x, args...; ObsPerYear::Int = 46, windowsize::Int = 9, edgecut::Int = 0, startidx::Int = 1, numoutvars::Int = 0)
  ...
  if numoutvars > 1
      for windowcenter = mwobj.iterator_windowcenter
        ...
        copy!(xout, function2mw(xin, args...))
